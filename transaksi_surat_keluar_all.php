                            ...
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1" style="background-color:#39424c!important;">
                                    <div class="col m7" style="background-color:#39424c!important;">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hide-on-small-only"><a href="?page=tskall" class="judul"><i class="material-icons">drafts</i> Semua Surat Keluar</a></li>
                ...
                <?php
					...
					if(isset($_REQUEST['submit'])){
                                ...
                                //script untuk mencari data
								  $query = mysqli_query($config, "SELECT * FROM tabel_surat_keluar WHERE id_user<>9999 AND (isi LIKE '%$cari%' OR nama LIKE '%$cari%' OR no_surat LIKE '%$cari%' OR tgl_surat LIKE '%$cari%' OR tujuan LIKE '%$cari%' OR no_agenda LIKE '%$cari%') ORDER by id_surat DESC");
						...
						$cdata=0;}
                            ...
                            //script untuk mencari data
								  ...
								  $queryf = mysqli_query($config, "SELECT * FROM tabel_surat_keluar");
...
$('#halaman').change(function(){
	var x = $(this).val();
	window.location.href='admin.php?page=tskall&pg='+ x;
		});
