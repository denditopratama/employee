                        ...
                        if(!preg_match("/^[0-9 -]*$/", $batas_waktu)){
                            ...
                            if(!preg_match("/^[a-zA-Z0-9.,()%@\/ -]*$/", $catatan)){
                                ...
                                if(!preg_match("/^[a-zA-Z0 ]*$/", $sifat)){
                                    ...
                                    $query = mysqli_query($config, "INSERT INTO tbl_disposisi(nama,isi_disposisi,sifat,batas_waktu,catatan,id_surat,dari,status)
                                        VALUES('".$_POST['idsuser']."','$isi_disposisi','$sifat','$batas_waktu','$catatan','$id_surat','".$_SESSION['nama']."','1')");
										$queroy= mysqli_query($config,"UPDATE tbl_surat_masuk SET tujuan ='".$_POST['idsuser']."',status='1' WHERE id_surat='$id_surat'");
