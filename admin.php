...
.hvr-icon-buzz5:before {
  ...
  animation-iteration-count: infinite;
    ...
    ?>
        ...
        <div class="row">
            ...
            <?php
                ...
                $count5 = mysqli_num_rows(mysqli_query($config, "SELECT * FROM tbl_user WHERE id_user <>9999 AND (admin<>1 AND admin<>12 AND status_aktif=1)"));
				if($_SESSION['admin']!=1){
	...
	<?php
			...
			$nbmb=mysqli_query($config,"SELECT tbl_user.*,tbl_identitas.jenis_kelamin FROM tbl_user,tbl_identitas WHERE tbl_user.admin<>1 AND(tbl_user.status_aktif=1 AND tbl_user.id_user<>9999 AND tbl_user.admin<>12 AND tbl_identitas.jenis_kelamin='L' AND tbl_user.id_user=tbl_identitas.id_user)");
		$rekapkel=mysqli_num_rows($nbmb);

		$nbmbf=mysqli_query($config,"SELECT tbl_user.*,tbl_identitas.jenis_kelamin FROM tbl_user,tbl_identitas WHERE tbl_user.admin<>1 AND(tbl_user.status_aktif=1 AND tbl_user.id_user<>9999 AND tbl_user.admin<>12 AND tbl_identitas.jenis_kelamin='P' AND tbl_user.id_user=tbl_identitas.id_user)");
		$rekapkels=mysqli_num_rows($nbmbf);
			...
			<div id="chart_wrap" style="height:375px!important">
	...
	<?php
			...
			$rekapjenkel1=mysqli_query($config,"SELECT COUNT(status_karyawan) FROM tbl_user WHERE status_karyawan='1' AND(admin<>1 AND admin<>12 AND id_user<>9999 AND status_aktif=1)");
			...
			$rekapjenkel3=mysqli_query($config,"SELECT COUNT(status_karyawan) FROM tbl_user WHERE status_karyawan='3' AND(admin<>1 AND admin<>12 AND id_user<>9999 AND status_aktif=1)");
			list($karyawanbantuv)=mysqli_fetch_array($rekapjenkel3);
			$rekapjenkel4=mysqli_query($config,"SELECT COUNT(status_karyawan) FROM tbl_user WHERE status_karyawan='4' AND(admin<>1 AND admin<>12 AND id_user<>9999 AND status_aktif=1)");
			list($karyawantetapv)=mysqli_fetch_array($rekapjenkel4);
			$rekapjenkel5=mysqli_query($config,"SELECT COUNT(status_karyawan) FROM tbl_user WHERE status_karyawan='5' AND(admin<>1 AND admin<>12 AND id_user<>9999 AND status_aktif=1)");
			...
			<div id="chart_wraps" style="height:375px!important">
					...
					<div class="card white">
                            <table class="bordered" id="tbls">
								...
								<p style="text-align:center;display:inline"><strong> Rekapitulasi Jabatan</strong></p></div>
									...
									<?php
									$dir=mysqli_query($config,"SELECT COUNT(admin) FROM tbl_user WHERE admin=2 AND(admin<>1 AND admin<>12 AND id_user<>9999 AND status_aktif=1)");
									list($dirut)=mysqli_fetch_array($dir);
									$disr=mysqli_query($config,"SELECT COUNT(admin) FROM tbl_user WHERE admin=3 AND(admin<>1 AND admin<>12 AND id_user<>9999 AND status_aktif=1)");
									list($dirsi)=mysqli_fetch_array($disr);
									$kosv=mysqli_query($config,"SELECT COUNT(admin) FROM tbl_user WHERE admin=4 AND(admin<>1 AND admin<>12 AND id_user<>9999 AND status_aktif=1)");
									...
									$mg=mysqli_query($config,"SELECT * FROM tbl_user WHERE jabatan='".$row['id']."' AND admin=5 AND(admin<>1 AND admin<>12 AND id_user<>9999 AND status_aktif=1)");
									...
									$sp=array();
									$special=mysqli_query($config,"SELECT id FROM tbl_ref_jabatan WHERE jabatan LIKE '%SPECIALIST%'");
									while($row=mysqli_fetch_array($special)){
									$specialist=mysqli_query($config,"SELECT * FROM tbl_user WHERE jabatan='".$row['id']."' AND admin=5 AND(admin<>1 AND admin<>12 AND id_user<>9999 AND status_aktif=1)");
									while($rowa=mysqli_fetch_array($specialist)){
										array_push($sp,$rowa['id_user']);
									}
									}
									...
									$mgd=mysqli_query($config,"SELECT * FROM tbl_user WHERE jabatan='".$row['id']."' AND admin=5 AND(admin<>1 AND admin<>12 AND id_user<>9999 AND status_aktif=1)");
									...
									$smsm=mysqli_query($config,"SELECT * FROM tbl_user WHERE jabatan='".$row['id']."' AND admin=6 AND(admin<>1 AND admin<>12 AND id_user<>9999 AND status_aktif=1)");
									...
									$kr=array();
									$kepalarest=mysqli_query($config,"SELECT id FROM tbl_ref_jabatan WHERE jabatan  LIKE '%KEPALA%'");
									while($row=mysqli_fetch_array($kepalarest)){
									$kepalarea=mysqli_query($config,"SELECT * FROM tbl_user WHERE jabatan='".$row['id']."' AND admin=11 AND(admin<>1 AND admin<>12 AND id_user<>9999 AND status_aktif=1)");
									while($rowa=mysqli_fetch_array($kepalarea)){
										array_push($kr,$rowa['id_user']);
									}
									}
									...
									$asb=mysqli_query($config,"SELECT * FROM tbl_user WHERE jabatan='".$row['id']."' AND admin=6 AND(admin<>1 AND admin<>12 AND id_user<>9999 AND status_aktif=1)");
									...
									$sokap=mysqli_query($config,"SELECT * FROM tbl_user WHERE admin=7 AND(admin<>1 AND admin<>12 AND id_user<>9999 AND status_aktif=1)");
									...
									$of=array();
									$sokaps=mysqli_query($config,"SELECT * FROM tbl_user WHERE admin=8 AND(admin<>1 AND admin<>12 AND id_user<>9999 AND status_aktif=1)");
									...
									?>
										...
										<td style="text-align:center">
										<input type="text" style="text-align:center;border-bottom:none" value="Specialist" disabled>
										</td>

										<td style="text-align:center">

										<input type="text" style="text-align:center;border-bottom:none" value="<?php echo count($sp); ?>" disabled>
										</td>
										</tbody>
										...
										<td style="text-align:center">
										<input type="text" style="text-align:center;border-bottom:none" value="Kepala Rest Area" disabled>
										</td>

										<td style="text-align:center">

										<input type="text" style="text-align:center;border-bottom:none" value="<?php echo count($kr); ?>" disabled>
										</td>
										</tbody>
