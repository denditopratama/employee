                ...
                <?php
                    ...
                    $cari = mysqli_real_escape_string($config, $_REQUEST['cari']);
                        ...
                        <table class="bordered" id="tblv">
                            ...
                            $query = mysqli_query($config, "SELECT * FROM tabel_surat WHERE id_user='".$_SESSION['id_user']."' AND (isi LIKE '%$cari%' OR keterangan LIKE '%$cari%' OR nama LIKE '%$cari%' OR kode LIKE '%$cari%' OR tgl_surat LIKE '%$cari%' OR asal_surat LIKE '%$cari%') ORDER by id_surat DESC LIMIT $curr, $limit");
