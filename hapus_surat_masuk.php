<?php
    ...
    if(empty($_SESSION['admin'])){
    	...
    	if(mysqli_num_rows($query) > 0){
            ...
            if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 8){
				...
				<div class="row jarak-card">
                    ...
                    <div class="card">
                        ...
                        <div class="card-action">
        	                ...
        	                <a href="?page=tsmall" class="btn-large blue waves-effect waves-light white-text">BATAL <i class="material-icons">clear</i></a>
    	                </div>
    	            </div>
                </div>
            </div>
            <!-- Row form END -->';
            	...
            	if(isset($_REQUEST['submit'])){
                    ...
                    if(!empty($row['file'])){
                        ...
                        $query = mysqli_query($config, "DELETE FROM tbl_surat_masuk WHERE id_surat='$id_surat'");
                        $query2 = mysqli_query($config, "DELETE FROM tbl_disposisi WHERE id_surat='$id_surat'");
						$query3 = mysqli_query($config, "DELETE FROM tbl_surat_keluar WHERE id_surat='$id_surat'");
