  ...
  client_id: '49446115720-gacrc8lhqmdj9rpn3efdpdsa3kh74usu.apps.googleusercontent.com'
				...
				<script type="text/javascript" src="js/gsignup.js"></script>
						...
						if(isset($_REQUEST['submitidentitas'])){
							...
							$customgaji=mysqli_real_escape_string($config,$_POST['customgaji']);
							...
							if($_SESSION['admin']==1){
								$apdepartment=mysqli_query($config,"UPDATE tbl_user SET unit='$unit_kerja',sub_unit='$sub_unit',jabatan='$jabatan',custom='$customgaji' WHERE id_user='$id_user'");
							} else {
								$apdepartment=true;
							}
