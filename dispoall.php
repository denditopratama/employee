                                            ...
                                            <div class="nav-wrapper blue-grey darken-1">
                                                <div class="col m12">
                                                    <ul class="left">
														...
														echo'
                                                        <li class="waves-effect waves-light hide-on-small-only"><a href="?page=tsmall">' ;}
														else {
														echo'
                                                        <li class="waves-effect waves-light hide-on-small-only"><a href="?page=tsm">'	;
														}
                                    ...
                                    <table class="bordered" id="tbl">
                                        <thead class="blue lighten-4" id="head">
                                            <tr>
                                                ...
                                                <th width="24%">Sifat<br/><hr style="background-color:black">Batas Waktu</th>
                                        ...
                                        if(mysqli_num_rows($query2) > 0){
                                            ...
                                            $no++;
                                             echo ' <td>'.$no.'</td>
                                                    ...
                                                    <td>'.$row['sifat'].'<br/><hr style="background-color:rgba(0,0,0,0.3)">'.$d." ".$nm." ".$y.'</td><td>';
														
															
																	   if($_SESSION['admin']==1){
														echo'
                                                    <a class="btn small blue waves-effect waves-light" href="?page=tsm&act=disp&id_surat='.$row['id_surat'].'&sub=edit&id_disposisi='.$row['id_disposisi'].'">
														<i class="material-icons">edit</i> EDIT</a>
														<a class="btn small deep-orange waves-effect waves-light" href="?page=tsm&act=disp&id_surat='.$row['id_surat'].'&sub=del&id_disposisi='.$row['id_disposisi'].'"><i class="material-icons">delete</i> DEL</a>';}
