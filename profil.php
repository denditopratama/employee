        ...
        if(isset($_REQUEST['sub'])){
                                            ...
                                            if($file != ""){
                                                ...
                                                if(in_array($eks, $ekstensi) == true){
                                                    if($ukuran < 5500000){
                                                        ...
                                                        $id_user = $_SESSION['id_user'];
                                                        $query = mysqli_query($config, "SELECT foto FROM tbl_user WHERE id_user='$id_user'");
                                                        list($foto) = mysqli_fetch_array($query);
            ...
            list($foto) = mysqli_fetch_array($queryt);?>
                ...
                <div class="row jarak-form">
                    ...
                    <!-- Form START -->
                    <form class="col s12" method="POST" action="?page=pro&sub=pass" enctype="multipart/form-data">
							...
							<div class="input-field col s6">
                                <div class="file-field input-field tooltipped" data-position="top" data-tooltip="Upload Foto Profile">
                                    ...
                                    <div class="file-path-wrapper">
                                        <input class="file-path validate" type="text" value="<?php echo $foto ;?>" placeholder="Upload Foto Profile">
