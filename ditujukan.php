    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
                                        ...
                                        if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $keterangan)){
                                            ...
                                            if($result > 0){
                                                ...
                                                if($file != ""){
                                                    ...
                                                    if(in_array($eks, $ekstensi) == true){
                                                        if($ukuran < 2500000){
                                                            ...
                                                            $query = mysqli_query($config, "INSERT INTO tbl_surat_keluar(no_agenda,tujuan,no_surat,isi,kode,tgl_surat,
                                                                ...
                                                                VALUES('$no_agenda','".$_POST['tujuan']."','$no_surat','$isi','$kode','$tgl_surat',NOW(),'$nfile','$keterangan','$id_user')");
                                                    ...
                                                    $query = mysqli_query($config, "INSERT INTO tbl_surat_keluar(no_agenda,tujuan,no_surat,isi,kode,tgl_surat,
                                                        tgl_catat,file,keterangan,id_user)
                                                        VALUES('$no_agenda','".$_POST['tampung']."','$no_surat','$isi','$kode','$tgl_surat',NOW(),'','$keterangan','$id_user')");
            ...
            <div class="row jarak-form">
                ...
                <!-- Form START -->
                <form class="col s12" method="POST" action="?page=tskall&act=add" enctype="multipart/form-data">
					...
					<div class="input-field col s6">
                            ...
                            <input id="kesatu" type="radio" class="validate" name="tujuan" value="1" checked="checked" onclick="tampil1()" >
                            <label for="kesatu">Institusi / Perusahaan Luar</label>
							<input id="kedua" type="radio" class="validate" name="tujuan" value="2" onclick="tampil2()">
						    <label for="kedua">Karyawan Internal</label>
                    ...
                    <div class="row">
						...
						else {echo '<a href="?page=tskall" class="btn-large deep-orange waves-effect waves-light">BATAL <i class="material-icons">clear</i></a>';}
						?>
