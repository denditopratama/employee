            ...
            <div class="row jarak-form">
                ...
                <form class="col s12" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
						...
						<input id="namabarang" type="text" class="validate" name="namabarang" required> 
						...
						<input id="tipebarang" type="text" class="validate" name="tipebarang" required> 
						...
						<input id="nomorseri" type="text" class="validate" name="nomorseri" required> 
                        ...
                        <div class="input-field col s12 m6">
                            ...
                            <input id="tgl_surat" type="text" name="tgl_invent" class="datepicker" required>
                                <?php
