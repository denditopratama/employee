        ...
        if(isset($_REQUEST['sub'])){
            ...
            $pg = @$_GET['pg'];
               ...
               // $id_surat = $_REQUEST['id_surat'];
                ...
                $query = mysqli_query($config, "SELECT * FROM tbl_disposisi WHERE id_user_tujuan='".$_SESSION['id_user']."'");
                            ...
                            <div class="col s12">
                                <div class="card blue lighten-5">
                                    <div class="card-content">
                                        <p><p class="description">Perihal Surat:</p>'.$row['isi_disposisi'].'</p>
                                    </div>
                                </div>
                            </div>
                            <!-- Perihal END -->';
                            ...
                            <div class="row jarak-form">
                                ...
                                <div class="col m12" id="colres">
                                    <table class="bordered" id="tbl">
                                        ...
                                        $query2 = mysqli_query($config, "SELECT * FROM tbl_disposisi WHERE tbl_disposisi.id_user_tujuan='".$_SESSION['id_user']."'");
